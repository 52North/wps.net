...
namespace Wps.Client.Services
{
    public interface IWpsClient
    {
        ...
        /// <summary>
        /// Get the exception report for a given request.
        /// </summary>
        /// <param name="wpsUri">The address pointing to the WPS server.</param>
        /// <param name="request">The request to be sent to the WPS server.</param>
        /// <returns>The exception report generated by the faulty exception.</returns>
        Task<ExceptionReport> GetExceptionForRequest(string wpsUri, Request request);
